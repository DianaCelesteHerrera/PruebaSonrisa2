...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    $to = "lcd-concierge-pacient-aaaaki64rpshgtrhtsivjzesti@dentalnetworkespacio.slack.com";
    ...
    $boundary = md5(time());
    $headers = "From: Prueba sonrisa <lcd-concierge-pacient-aaaaki64rpshgtrhtsivjzesti@dentalnetworkespacio.slack.com>\r\n";
